package com.taenki.netty.protocol.nonstandard;

import com.taenki.netty.protocol.nonstandard.handler.codec.MarshallingDecoder;
import com.taenki.netty.protocol.nonstandard.handler.codec.MarshallingEncoder;
...
public class CodecTest {
    ...
    public void test() throws Exception {
        NettyMessage message = getMessage();
        System.out.println(message + "[body ] " + message.getBody());

        for (int i = 0; i < 5; i++) {
            ByteBuf buf = encode(message);
            NettyMessage decodeMsg = decode(buf);
